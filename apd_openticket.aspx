<%@ Page Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true"
    CodeFile="apd_openticket.aspx.cs" Inherits="apd_openticket" Title="PrimeDoc | Open tickets" %>
            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="apd_openticket.aspx">Open tickets</a></li>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="ibox">
                                                    ...
                                                    <asp:GridView ID="gvOpenTickets" runat="server" GridLines="None" AutoGenerateColumns="false"
