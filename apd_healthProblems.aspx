<%@ Page Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true"
    CodeFile="apd_healthProblems.aspx.cs" Inherits="apd_healthProblems" Title="PrimeDoc | Health Problem" %>
            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="apd_healthProblems.aspx">Health Problems</a></li>
                                    ...
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">
                                                Health Problems</label>
                                            <div class="col-sm-10">
                                                <%--<textarea class="form-control"></textarea>--%>
                                                <asp:TextBox ID="tbHealthProblems" runat="server" TextMode="MultiLine" class="form-control"></asp:TextBox>
                                                   <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please enter Healthproblems"
                    ControlToValidate="tbHealthProblems" Display="Dynamic" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <%--<textarea class="form-control"></textarea>--%>
                                                <asp:TextBox ID="tbOthers" runat="server" TextMode="MultiLine" class="form-control"></asp:TextBox>
                                                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please enter OtherHealthproblems"
                    ControlToValidate="tbOthers" Display="Dynamic" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                    </div>
                                    <%--<div class="hr-line-dashed">
