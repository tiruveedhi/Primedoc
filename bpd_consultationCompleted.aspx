<%@ Page Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true"
    CodeFile="bpd_consultationCompleted.aspx.cs" Inherits="bpd_consultationCompleted"
            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="bpd_consultationCompleted.aspx">Completed</a></li>
                                        ...
                                        <div style="height: 520px; overflow: auto">
                                            <asp:GridView ID="gvConslCompleted" runat="server" GridLines="None" AutoGenerateColumns="false"
                                                ...
                                                <Columns>
                                                    ...
                                                    <%--<asp:BoundField DataField="Patient query" HeaderText="Patient query" />--%>
