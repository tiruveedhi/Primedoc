<%@ Page Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true"
    CodeFile="deleteMessages.aspx.cs" Inherits="deleteMessages" Title="PrimeDoc | Messages" %>
            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="deleteMessages.aspx">Deleted</a></li>
                    </ul>
                            ...
                            <div class="panel-body">
                                <div class="ibox-content">
                                    <div class="form-horizontal">
                                        <asp:GridView ID="gvDeletedMessages" runat="server" GridLines="None" AutoGenerateColumns="false"
