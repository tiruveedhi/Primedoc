<%@ Page Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true"
    CodeFile="cpd_consultationpickedup.aspx.cs" Inherits="cpd_consultationpickedup"
        ...
        <ContentTemplate>
                    ...
                    <div class="col-sm-12">
                        <div class="tabs-container">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="active"><a href="cpd_consultationpickedup.aspx">PickedUp</a></li>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="ibox">
                                                            ...
                                                            <asp:GridView ID="gvPickedup" runat="server" GridLines="None" AutoGenerateColumns="false"
                                                           ...
                                                           <asp:Label ID="lbl_patname" runat="server" Text='<%# Eval("Name") %>' />
                                                                    ...
                                                                    <%--<asp:TemplateField>
                                                                            <ItemTemplate>
                                                                                <asp:Button runat="server" Text="Edit" ID="btnEdit" class="btn btn-sm btn-primary m-t-n-xs"
            ...
            <asp:Panel ID="panelEdit" runat="server" Style="display: none; background-color: White;"
                ...
                <asp:GridView ID="gvEditAlterDocs" runat="server" AutoGenerateColumns="false" OnRowEditing="gvEditAlterDocs_RowEditing"
                    ...
                    EditRowStyle-BorderColor="Red" OnRowUpdating="gvEditAlterDocs_RowUpdating">
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="btnEditStatus" runat="server" CommandName="Edit" Text="Make Active" />
                            </ItemTemplate>
                            <EditItemTemplate>
