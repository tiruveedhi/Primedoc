<%@ Page Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true"
    CodeFile="apd_home.aspx.cs" Inherits="apd_home" Title="PrimeDoc | Home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="sidebard-panel">
        ...
        <%--<span class="badge badge-info pull-right"><%=Session["count"]%></span>--%>
        ...
        <%-- <div class="feed-element">
                ...
                <div class="media-body">
                    Dr. Williams is currently reviewing your request for Second Opinion with ID 15345.
                    <br>
            ...
            <div class="feed-element">
                ...
                <div class="media-body">
                    Thank you for using our services. Your request for Second Opinion with ID 15345
                    is now Active.
                    <br>
            ...
            <div class="feed-element">
                ...
                <div class="media-body">
                    Welcome to Prime Doc Ramesh Naidu M. We hope you will find our services to exceed
                    your expectations.
                    <br>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content" id="consult" runat="server">
                        <%--     <h1 class="no-margins">
                            2</h1>
                        <br>
                        <small>1 Picked Up</small><br>
                        <small>1 In Queue</small>--%>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content inspinia-timeline" id="offers" runat="server">
