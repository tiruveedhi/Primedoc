<%@ Page Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="bpd_liveConsultationlist.aspx.cs" Inherits="bpd_liveConsultationlist" Title="Prime Doc | Consultation List" %>
            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        <li class=""><a href="bpd_liveConsultation.aspx">LiveConsultation</a></li>
                        <li class="active"><a href="bpd_liveConsultationlist.aspx">LiveConsultation list</a></li>
                    </ul>
                           ...
                           <div class="panel-body">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <Columns>
                                                     <asp:BoundField DataField="LC_PAT_ID" HeaderText="Patientid" />                                          
