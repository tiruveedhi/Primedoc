<%@ Page Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true"
    CodeFile="apd_allergies.aspx.cs" Inherits="apd_allergies" Title="PrimeDoc | Allergies" %>
            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="apd_allergies.aspx">Allergies</a></li>
                                    ...
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <asp:TextBox ID="tbAllergies" runat="server" TextMode="MultiLine" class="form-control"></asp:TextBox></div>
                                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please enter Allergies"
                    ControlToValidate="tbAllergies" Display="Dynamic" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                        </div>
