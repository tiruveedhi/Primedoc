<%@ Page Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true"
    CodeFile="apd_radiology.aspx.cs" Inherits="apd_radiology" Title="PrimeDoc | Radiology" %>
            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="apd_radiology.aspx">Radiology</a></li>
                    </ul>
                                    ...
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">
                                                Radiology </label><%--report--%>
                                            <div class="col-sm-10">
                                                <%--<asp:Image ID="Image1" runat="server" ImageUrl="" />
                                                <a href="" target="_blank">
                                                    <asp:Image ID="Image2" runat="server" ImageUrl="" /></a>--%>
                                                <asp:TextBox ID="tbradiology" runat="server" TextMode="MultiLine" class="form-control"></asp:TextBox>
                                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please enter Radiology"
                    ControlToValidate="tbradiology" Display="Dynamic" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
