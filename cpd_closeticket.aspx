<%@ Page Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true"
    CodeFile="cpd_closeticket.aspx.cs" Inherits="cpd_closeticket" Title="PrimeDoc | Closed tickets" %>
            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        <li class=""><a href="cpd_openticket.aspx">Open tickets</a></li>
                        <li class="active"><a href="cpd_closeticket.aspx">Close tickets</a></li>
                    </ul>
