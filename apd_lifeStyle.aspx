<%@ Page Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true"
    CodeFile="apd_lifeStyle.aspx.cs" Inherits="apd_lifeStyle" Title="PrimeDoc | Life Style" %>
            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="apd_lifeStyle.aspx">Life Style</a></li>
                                    ...
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <asp:TextBox ID="tblifestyle" runat="server" TextMode="MultiLine" class="form-control"></asp:TextBox></div>
                                                   <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please enter lifestyle"
                    ControlToValidate="tblifestyle" Display="Dynamic" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                   <%-- <div class="hr-line-dashed">
                                    </div>--%>
                                    <asp:Button ID="Button1" runat="server" Text="Submit" class="btn btn-primary pull-right"
