<%@ Page Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true"
    CodeFile="apd_consultationCompleted.aspx.cs" Inherits="apd_consultationCompleted"
            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="apd_consultationCompleted.aspx">Completed</a></li>
                            ...
                            <div class="panel-body">
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <asp:GridView ID="gvConslCompleted" runat="server" GridLines="None" AutoGenerateColumns="false"
                                            class='footable table table-stripped toggle-arrow-tiny' AllowPaging="true" OnPageIndexChanging="OnPageIndexChanging"
                                            OnRowDataBound="gvConslCompleted_RowDataBound">
                                            <Columns>
                                                ...
                                                <%--<asp:BoundField DataField="CNS_SEC_OPINION" HeaderText="Second opinion"/>--%>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
