<%@ Page Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true"
    CodeFile="apd_medications.aspx.cs" Inherits="apd_medications" Title="PrimeDoc | Medications" %>
            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="apd_medications.aspx">Medications</a></li>
                                    ...
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <asp:TextBox ID="tbMedications" runat="server" TextMode="MultiLine" class="form-control"></asp:TextBox></div>
                                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please enter medication"
                    ControlToValidate="tbMedications" Display="Dynamic" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
